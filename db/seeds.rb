...
#   end
    ...
    Flight.create!(departure_airport: Airport.find_by(code: 'KYN'), arrival_airport: Airport.find_by(code: 'LBA'), start: DateTime.new(2024, 1, 28, 21, 0, 0), duration_hours: 2, duration_minutes: 20)
    Flight.create!(departure_airport: Airport.find_by(code: 'KYN'), arrival_airport: Airport.find_by(code: 'LHR'), start: DateTime.new(2024, 1, 29, 22, 20, 0), duration_hours: 1, duration_minutes: 10)
    Flight.create!(departure_airport: Airport.find_by(code: 'KYN'), arrival_airport: Airport.find_by(code: 'LTN'), start: DateTime.new(2024, 1, 30, 1, 0, 0), duration_hours: 1, duration_minutes: 00)
    Flight.create!(departure_airport: Airport.find_by(code: 'LBA'), arrival_airport: Airport.find_by(code: 'KYN'), start: DateTime.new(2024, 1, 28, 21, 30, 0), duration_hours: 2, duration_minutes: 20)
    Flight.create!(departure_airport: Airport.find_by(code: 'LBA'), arrival_airport: Airport.find_by(code: 'LHR'), start: DateTime.new(2024, 1, 29, 21, 50, 0), duration_hours: 2, duration_minutes: 30)
    Flight.create!(departure_airport: Airport.find_by(code: 'LHR'), arrival_airport: Airport.find_by(code: 'LBA'), start: DateTime.new(2024, 1, 31, 1, 0, 0), duration_hours: 2, duration_minutes: 30)
    Flight.create!(departure_airport: Airport.find_by(code: 'LHR'), arrival_airport: Airport.find_by(code: 'KYN'), start: DateTime.new(2024, 1, 28, 3, 0, 0), duration_hours: 1, duration_minutes: 10)
    Flight.create!(departure_airport: Airport.find_by(code: 'LHR'), arrival_airport: Airport.find_by(code: 'LTN'), start: DateTime.new(2024, 1, 29, 3, 0, 0), duration_hours: 1, duration_minutes: 10)
    Flight.create!(departure_airport: Airport.find_by(code: 'LTN'), arrival_airport: Airport.find_by(code: 'LHR'), start: DateTime.new(2024, 1, 30, 23, 10, 0), duration_hours: 1, duration_minutes: 10)
    Flight.create!(departure_airport: Airport.find_by(code: 'LTN'), arrival_airport: Airport.find_by(code: 'KYN'), start: DateTime.new(2024, 1, 31, 0, 30, 0), duration_hours: 1, duration_minutes: 00)